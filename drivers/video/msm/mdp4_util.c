...
void mdp4_display_intf_sel(int output, ulong intf)
{
	...
	case SECONDARY_INTF_SEL:
		//sumeet: the line below is buggy. INTF_EBI2 is 0x3; so below line makes it 0x2, MDDI!!
...
#ifndef LGE_MODEL_C729 //05feb11: DMA_S hardcoding for EBI2 for flip.
