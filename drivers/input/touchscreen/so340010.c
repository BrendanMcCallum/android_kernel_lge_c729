...
static struct reg_code_table initial_code_table[] = {
	...
	{TSKEY_REG_DUMMY,	TSKEY_REG_SEN1, 		0xD2,				0xAA},
	{TSKEY_REG_DUMMY,	TSKEY_REG_SEN2, 		0xD2,				0xD2},
...
static DEVICE_ATTR(set_sen, S_IRUGO | S_IWUSR | S_IWOTH | S_IXOTH, so340010_set_sen_show, so340010_set_sen_store);
