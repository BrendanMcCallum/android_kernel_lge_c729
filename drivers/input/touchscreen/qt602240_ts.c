...
static const u8 init_vals_ver_32[] = {
	...
	0x00, 0x03, 0x01, 0x00, 0x0a, 0x0a, 0x0a, 0x0a, 0x1F, 0x03,
	...
	0x00, 0x00,
	/* QT602240_PROCG_NOISE(22) */
	0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x14, 0x00,
	0x00, 0x0A, 0x0F, 0x14, 0x19, 0x1E, 0x03,
	/* QT602240_TOUCH_PROXIMITY(23) */
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00,
	/* QT602240_PROCI_ONETOUCH(24) */
...
#if defined(CONFIG_MACH_MSM8X55_VICTOR) || defined(CONFIG_MACH_MSM8X55_UNIVA_Q) || defined(CONFIG_MACH_MSM8X55_FLIP)
	static DEVICE_ATTR(firm_status, S_IRUGO | S_IWUSR | S_IWOTH | S_IXOTH, qt602240_firm_status_show, NULL);
...
static void qt602240_start(struct qt602240_data *data)
{
	...
	qt602240_write_object(data,
			QT602240_GEN_POWER, QT602240_POWER_IDLEACQINT, 0xFF);
