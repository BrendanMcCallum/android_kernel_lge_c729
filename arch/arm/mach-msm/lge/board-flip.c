...
static struct platform_device *devices[] __initdata = {
	...
	&msm_ebi0_thermal,
	&msm_ebi1_thermal
// BEGIN youngil.yun@lge.com Add device( rotator & 720P)
	,&msm_device_vidc_720p,		// Video Codec
#ifdef CONFIG_MSM_ROTATOR
	&msm_rotator_device,
#endif
// END youngil.yun@lge.com Add device( rotator & 720P)
...
{
	unsigned on =1;
	int fn_type = 0; // CUSTOMER_CMD1_SET_SPECIAL_CLOCK0

	printk("pm8058_special_clock0_setting \n");
...
MACHINE_START(MSM8X55_FLIP, "LGE MSM8X55 FLIP")
