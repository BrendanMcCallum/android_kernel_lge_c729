...
u8 QTR_cal_data[QTR_CAL_MAX][4] = {
  ...
  s16 voice_level_data[4][2] = {
    ...
    {500,-1500},
    {400,-1100}};
#elif defined(LGE_MODEL_C729)
  int voice_level_data[4][2] = {
    {0,-2400},
    {-100,-1600},
    {1000,-1000},
    {400,-1100}};
...
u8 QTR_cal_data[QTR_CAL_MAX][4] = {
    {0x08, 0xFF,0xFF,0xFF}, //QTR_EARPIECE
    {0x6,0x6,0x10,0x10},      //QTR_HEADSET_VOICE
    {0x05,0x05,0xFF,0xFF},      //QTR_SPEAKER_VOICE
    {0x0,0x0,0x10,0x10},          //QTR_TTY
    {0x8,0x8,0x10,0x10},        //QTR_HEADSET_AUDIO
    {0x0,0x0,0x10,0x10},        //QTR_HEADSET_SPEAKER
    {0x0,0x0,0xFF,0xFF},        //QTR_SPEAKER_AUDIO
    {0xD,0xD0,0xFF,0xFF},     //QTR_HANDSET_MIC
    {0xE,0xC8,0xFF,0xFF},     //QTR_HEADSET_MIC
    {0xB,0xC1,0xFF,0xFF},     //QTR_SPEAKER_MIC
    {0x0,0xA8,0xFF,0xFF},     //QTR_TTY_MIC
    {0x1B,0xD0,0xFF,0xFF},    //QTR_REC_MIC
    {0x14,0xD0,0xFF,0xFF},    //QTR_CAM_MIC
    {0x05,0xD0,0xFF,0xFF}};    //QTR_VOICE_MIC
        ...
        case SET_AUDIO_CAL:
		  ...
		  if (lb_path <10)
		  {
			lmsg.args.mode = cpu_to_be32( lb_path );
			  ...
			  rc = msm_rpc_call(audio->ept,RPC_VOEM_TTY_PROC,&lmsg, sizeof(lmsg), 5 * HZ);
			  if (rc < 0)
