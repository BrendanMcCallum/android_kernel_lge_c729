 ...
 */
#ifndef __ARCH_MSM_BOARD_FLIP_H
#define __ARCH_MSM_BOARD_FLIP_H
...
#define SYS_GPIO_SD_DET    44  /* SYS SD Detection GPIO Number 44 */
#define SYS_GPIO_SD_EN_N   87 /* SYS SD Enable GPIO Number 87*/
#endif
...
#define MAIN_TS_GPIO_INT			107
#define MAIN_TS_GPIO_IRQ			MSM_GPIO_TO_INT(MAIN_TS_GPIO_INT)
#define MAIN_TS_GPIO_CE				90


#define MXT224_TS_I2C_SLAVE_ADDR	0x4A
/* Sub touch */
#define SUB_TS_X_MIN				0
#define SUB_TS_X_MAX				320
#define SUB_TS_Y_MIN				0
#ifdef CONFIG_FB_MSM_DPSV
#define SUB_TS_X_SCRN_MAX			320
#define SUB_TS_Y_SCRN_MAX			240
#define SUB_TS_Y_MAX				720
#define SUB_TS_Y_START				480
#else
#define SUB_TS_X_SCRN_MAX			320
#define SUB_TS_Y_SCRN_MAX			240
#define SUB_TS_Y_MAX				320
#define SUB_TS_Y_START				0
#endif

#define SUB_TS_GPIO_I2C_SDA			38
#define SUB_TS_GPIO_I2C_SCL			37
#define SUB_TS_GPIO_INT				34
#define SUB_TS_GPIO_IRQ				MSM_GPIO_TO_INT(SUB_TS_GPIO_INT)
#define SUB_TS_GPIO_CE				91

#define MCS6000_TS_I2C_SLAVE_ADDR	0x20

/* sensors */
#define SENSORS_GPIO_I2C_SCL  	149
#define SENSORS_GPIO_I2C_SDA  	150

/* accelerometer */
#define ACCEL_GPIO_INT	 		88
#define ACCEL_GPIO_I2C_SCL  	149
#define ACCEL_GPIO_I2C_SDA  	150
...
#define ECOM_GPIO_INT			47
#define ECOM_I2C_ADDRESS		0x0c /* slave address 7bit */
