...
#ifdef CONFIG_LGE_RPC_DOG_CRASH_DEBUG
extern void WriteScheduleLogData(struct task_struct *);
#endif
 

 
#ifdef CONFIG_LGE_RPC_DOG_CRASH_DEBUG_SMEM
extern void WriteScheduleLogDataSmem(struct task_struct *);
#endif
